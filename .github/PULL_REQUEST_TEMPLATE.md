...
- URL del repositorio
- URL del servicio/API/institución castellanomanchega a la que da soporte (p.ej. castillalamancha.es, uclm.es, sescam.es)
Elimina esta sección si no aplica.
-->

| Proyecto | Servicio/Institución CLM |
|----------|--------------------------|
...
- URL del repositorio
- Motivo (archivado, no funcional, reemplazado, no específico de CLM, etc.)
Elimina esta sección si no aplica.
-->
