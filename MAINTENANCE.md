...
El criterio fundamental es: **se acepta software que da soporte específico a Castilla-La Mancha, no software hecho por alguien de Castilla-La Mancha.**

Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Castilla-La Mancha. No basta con que el autor resida o trabaje aquí. Un framework genérico creado por un developer de Castilla-La Mancha no pertenece a esta lista. Un cliente para la API de datos abiertos del gobierno de Castilla-La Mancha o una integración con servicios públicos de Castilla-La Mancha sí.

- **Sí:** Clientes de APIs de instituciones de Castilla-La Mancha, integraciones con servicios públicos regionales, scrapers de transporte o datos abiertos de Castilla-La Mancha.
- **No:** Librerías genéricas creadas por equipos de Castilla-La Mancha, software genérico cuyo autor simplemente reside en la comunidad.

Ver `AGENTS.md` (si existe) para criterios detallados adicionales.

## Revisar PRs

1. Comprobar que el proyecto **da soporte específico a Castilla-La Mancha** (no simplemente que el autor es de Castilla-La Mancha).
2. Verificar que la PR incluye la **URL del servicio o institución de Castilla-La Mancha** que el proyecto soporta.
...
4. Si el propietario del proyecto no ha sido notificado, abrir un issue de cortesía en su repo:
   - Título: `Incluido en awesome-castilla-la-mancha`
...
| No cumple criterios de inclusión | Eliminados por no ser específicos de Castilla-La Mancha |
