# Contribuir a Awesome Castilla-La Mancha
...
- El proyecto debe **dar soporte específico a Castilla-La Mancha** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución castellanomanchega** a la que el software da soporte (p.ej. castillalamancha.es, uclm.es, sescam.es). Esto ayuda a verificar que el proyecto es relevante para Castilla-La Mancha.
